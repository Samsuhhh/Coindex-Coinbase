...
Revision ID: 088a8afdd4ad
Revises: 
Create Date: 2022-12-05 03:54:11.904759
...
def upgrade():
    ...
    sa.Column('hashed_password', sa.String(length=105), nullable=False),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('last_four_digits', sa.String(length=10), nullable=False),
    sa.Column('cvc', sa.String(length=5), nullable=False),
    ...
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('wallet_address', sa.String(length=70), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('cash_value', sa.String(length=50), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('assets', sa.String(length=2000), nullable=False),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
